...
public class HospitalEmergencyNotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_emergency_notice);
        ...
        if (TextUtils.isEmpty(title)) {
            ...
            db.collection("emergencyRequest").add(data).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(HospitalEmergencyNotice.this, "Fail to Submit Request!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
