...
public class UserBloodRequestDetails extends AppCompatActivity {
                        ...
                        db.collection("emergencyRequest").document(requestId).delete()
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(UserBloodRequestDetails.this, "Request Deleted Successfully!", Toast.LENGTH_SHORT).show();
